              ...
              <div key={currency.id}>
                <label
                  ...
                  className={`flex items-center justify-between cursor-pointer w-full p-4 rounded-lg border-2 transition-colors ${
                    isSelected
                      ? "bg-slate-100 border-slate-900 dark:bg-slate-800 dark:border-slate-50"
                      : "bg-white border-slate-200 hover:bg-slate-100 dark:bg-slate-950 dark:border-slate-800 dark:hover:bg-slate-800"
                  }`}
                >
                  ...
                  {isSelected && <Check className="w-5 h-5 text-slate-900 dark:text-slate-50" />}
                </label>
              </div>
            );
          })}
